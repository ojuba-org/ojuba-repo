...
baseurl=https://copr-be.cloud.fedoraproject.org/results/moceap/Ojuba/epel-7-$basearch/
gpgcheck=1
...
[ojuba-rawhide]
name=Ojuba Software Repos
baseurl=https://copr-be.cloud.fedoraproject.org/results/moceap/Ojuba/fedora-rawhide-$basearch/
gpgcheck=1
gpgkey=https://copr-be.cloud.fedoraproject.org/results/moceap/Ojuba/pubkey.gpg
enabled=0
enabled_metadata=1' > ojuba.repo
